...
const glassSelectBase =
  "w-full rounded-xl border border-white/[0.10] bg-white/[0.05] px-4 text-sm text-white outline-none transition-all duration-200 backdrop-blur-xl focus:ring-2 focus:ring-cyan-400/30 appearance-none bg-no-repeat";
      ...
      <div className="w-full">
        ...
        <div className="relative">
          <select
            ref={ref}
            id={id}
            className={cn(glassSelectBase, "h-11 pr-10", className)}
            style={{
